...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/oreskovs/employee_management.git](https://github.com/oreskovs/employee_management.git)
    ```
...
3.  **Run the application:**
    ...
    ```
---
*Developed as part of a Flutter technical advancement track.*